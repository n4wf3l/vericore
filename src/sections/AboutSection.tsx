...
const AboutSection: React.FC = () => {
  ...
  const processSteps = [
    {
      icon: ClipboardCheck,
      title: t('about.method.steps.diagnostic.title'),
      description: t('about.method.steps.diagnostic.description')
    },
    {
      icon: Wrench,
      title: t('about.method.steps.intervention.title'),
      description: t('about.method.steps.intervention.description')
    },
    {
      icon: FileText,
      title: t('about.method.steps.reporting.title'),
      description: t('about.method.steps.reporting.description')
    },
    {
      icon: TrendingUp,
      title: t('about.method.steps.followup.title'),
      description: t('about.method.steps.followup.description')
    }
  ];

  const proofChips = [
    { icon: CheckCircle2, text: t('about.proofChips.sla') },
    { icon: Shield, text: t('about.proofChips.conformity') },
    { icon: Users, text: t('about.proofChips.unique') },
    { icon: FileText, text: t('about.proofChips.history') }
  ];
      ...
      <div className="container-custom relative z-10">
          ...
          >
            <motion.div variants={itemVariants}>
              <p 
                ...
                dangerouslySetInnerHTML={{ __html: t('about.mission.p1') }}
              />
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <p 
                className="text-gray-700 text-lg leading-relaxed"
                dangerouslySetInnerHTML={{ __html: t('about.mission.p2') }}
              />
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <p 
                className="text-gray-700 text-lg leading-relaxed"
                dangerouslySetInnerHTML={{ __html: t('about.mission.p3') }}
              />
            </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-primary-50 via-blue-50 to-white rounded-2xl p-8 md:p-10 shadow-lg border border-primary-100">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 items-center">
              <div className="space-y-4 md:col-span-2 lg:col-span-1">
                ...
                >
                  ...
                  <p 
                    ...
                    dangerouslySetInnerHTML={{ __html: t('about.commitments.points.employment.description') }}
                  />
                </motion.div>
                ...
                >
                  ...
                  <p 
                    className="text-gray-700 leading-relaxed"
                    dangerouslySetInnerHTML={{ __html: t('about.commitments.points.equality.description') }}
                  />
                </motion.div>
              </div>
              ...
              <div className="space-y-4 md:col-span-2 lg:col-span-1">
                ...
                >
                  ...
                  <p 
                    className="text-gray-700 leading-relaxed"
                    dangerouslySetInnerHTML={{ __html: t('about.commitments.points.inclusive.description') }}
                  />
                </motion.div>
                ...
                >
                  ...
                  <p 
                    className="text-gray-700 leading-relaxed"
                    dangerouslySetInnerHTML={{ __html: t('about.commitments.points.culture.description') }}
                  />
                </motion.div>
              </div>
